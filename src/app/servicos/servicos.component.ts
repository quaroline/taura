  ...
  servicos: any[] = [
    {
      ...
      descricao: $localize`Preparação de profissionais nos pilares:`,
    ...
    },
    {
      ...
      descricao: $localize`Identificação de riscos e vulnerabilidades em produtos e serviços, através de testes de intrusão (pentest), e também apoio no acompanhamento e e correção de vulnerabilidades encontradas através de gestão de vulnerabilidades`
    }
  ];
